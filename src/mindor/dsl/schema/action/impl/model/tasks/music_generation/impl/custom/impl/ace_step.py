...
class AceStepMusicGenerationParamsConfig(CommonMusicGenerationParamsConfig):
    ...
    use_adg: Union[bool, str] = Field(default=False, description="Whether to enable APG (adaptive projected guidance); recommended for base/sft presets.")
...
class AceStepMusicGenerationModelCoverActionConfig(CommonAceStepMusicGenerationModelActionConfig):
    ...
    source: str = Field(..., description="Path or URL of the source audio to create a cover from.")
...
class AceStepMusicGenerationModelRewriteActionConfig(CommonAceStepMusicGenerationModelActionConfig):
    ...
    source: str = Field(..., description="Path or URL of the source audio containing the region to rewrite.")
...
class AceStepMusicGenerationModelExtendActionConfig(CommonAceStepMusicGenerationModelActionConfig):
    ...
    source: str = Field(..., description="Path or URL of the source audio to continue past its end.")

...
class MusicSourceSeparationParamsConfig(BaseModel):
    ...
    output_sample_rate: Optional[Union[int, str]] = Field(default=None, description="Sample rate of the returned stem audio. Defaults to the model's native rate (Demucs: 44100, MDX-Net: 44100).")
...
class MusicSourceSeparationModelActionConfig(CommonModelActionConfig):
    ...
    sample_rate: Union[int, str] = Field(default=44100, description="Sample rate of the input audio in Hz.")

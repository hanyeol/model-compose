...
class ProcessRuntimeConfig(CommonRuntimeConfig):
    ...
    start_timeout: Optional[Union[str, int, float]] = Field(default=None, description="Maximum time to wait for the worker process to start and report ready.")
    stop_timeout: Optional[Union[str, int, float]] = Field(default=None, description="Maximum time to wait for the worker process to stop gracefully before being killed.")

...
class WebSocketConfig(BaseModel):
    ...
    ping_interval: str = Field(default="30s", description="Server-side ping interval (e.g. '30s'). '0s' to disable.")
    ping_timeout: str = Field(default="10s", description="Ping timeout (e.g. '10s').")

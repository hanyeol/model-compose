...
class CommonCameraPoseEstimatorActionConfig(CommonActionConfig):
    ...
    batch_size: Union[int, str] = Field(default=1, description="Number of scenes buffered before emitting results downstream on a streaming input; scenes within a batch are still reconstructed sequentially.")

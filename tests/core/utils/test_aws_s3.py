"""Tests for `core/utils/aws_s3.py` against an in-process moto server."""
...
from mindor.core.utils.aws_s3 import upload, multipart_upload, _MIN_PART_SIZE
from mindor.core.utils.streaming import BytesStreamResource, StreamResource


pytest_plugins = ["tests._fixtures.aws_s3"]

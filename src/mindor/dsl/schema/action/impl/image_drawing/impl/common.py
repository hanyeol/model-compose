...
class ImageDrawingPointActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Pixel color.")
...
class ImageDrawingLineActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Line color.")
...
class ImageDrawingArcActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Arc color.")
...
class ImageDrawingChordActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Interior fill color.")
    outline: Optional[Union[Color, str]] = Field(default=None, description="Outline color.")
...
class ImageDrawingTextActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Text color.")
    ...
    stroke_fill: Optional[Union[Color, str]] = Field(default=None, description="Text stroke color.")
...
class ImageDrawingBitmapActionConfig(CommonImageDrawingActionConfig):
    ...
    fill: Optional[Union[Color, str]] = Field(default=None, description="Color applied through the bitmap mask.")

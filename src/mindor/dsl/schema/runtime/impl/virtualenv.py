...
class VirtualEnvRuntimeConfig(CommonRuntimeConfig):
    ...
    path: Optional[str] = Field(default=None, description="Virtualenv directory path (relative to CWD).")
    python: Optional[str] = Field(default=None, description="Python version (pyenv driver only, e.g. '3.12.0').")
    env: Dict[str, str] = Field(default_factory=dict, description="Worker subprocess environment variables.")

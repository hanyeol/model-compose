...
class SshConnectionConfig(BaseModel):
    ...
    watch_interval: str = Field(default="5s", description="Interval between SSH connection health checks.")
    retry_interval: str = Field(default="5s", description="Interval between reconnection attempts.")

...
## 12.3 워크플로우에서 스트리밍 사용

### 12.3.1 기본 스트리밍 워크플로우
...
큐 스트리밍의 설정, 아키텍처, 엣지 케이스에 대한 자세한 내용은 [6.5장: 큐 스트리밍](./06-controller-configuration.md#65-큐-스트리밍-queue-streaming)을 참조하세요.
...
**다음 장**: [13. 변수 바인딩](./13-variable-binding.md)

...
class VllmEngineOptionsConfig(BaseModel):
    ...
    skip_tokenizer_init: Optional[bool] = Field(default=None, description="Whether to skip tokenizer and detokenizer initialization and expect pre-tokenized inputs.")
    enable_prompt_embeds: Optional[bool] = Field(default=None, description="Whether to accept prompt embeddings as inputs alongside text.")
    trust_remote_code: Optional[bool] = Field(default=None, description="Whether to execute custom model code shipped in the HuggingFace repository.")
    ...
    use_tqdm_on_load: Optional[bool] = Field(default=None, description="Whether to show a tqdm progress bar while loading weights.")
    ...
    allow_deprecated_quantization: Optional[bool] = Field(default=None, description="Whether to allow legacy quantization methods.")
    ...
    disable_sliding_window: Optional[bool] = Field(default=None, description="Whether to disable sliding window attention.")
    disable_cascade_attn: Optional[bool] = Field(default=None, description="Whether to disable cascade attention in the V1 engine.")
    override_attention_dtype: Optional[str] = Field(default=None, description="Attention computation precision to force regardless of model config.")
    ...
    enforce_eager: Optional[bool] = Field(default=None, description="Whether to disable CUDA graph capture and run in eager mode.")
    ...
    enable_prefix_caching: Optional[bool] = Field(default=None, description="Whether to enable automatic prefix caching.")
    ...
    kv_cache_dtype_skip_layers: Optional[List[str]] = Field(default=None, description="Layer names to exclude from KV cache quantization.")
    kv_sharing_fast_prefill: Optional[bool] = Field(default=None, description="Whether to enable the KV sharing fast-prefill optimization.")
    ...
    data_parallel_hybrid_lb: Optional[bool] = Field(default=None, description="Whether to enable per-node load balancing for data parallel replicas.")
    data_parallel_external_lb: Optional[bool] = Field(default=None, description="Whether to run in external load balancer mode.")
    ...
    numa_bind: Optional[bool] = Field(default=None, description="Whether to pin workers to NUMA nodes.")
    max_parallel_loading_workers: Optional[int] = Field(default=None, description="Maximum parallel loading workers.")
    ray_workers_use_nsight: Optional[bool] = Field(default=None, description="Whether to profile Ray workers with nsight.")
    disable_custom_all_reduce: Optional[bool] = Field(default=None, description="Whether to disable the custom all-reduce kernel.")
    ...
    # Expert / MoE
    enable_expert_parallel: Optional[bool] = Field(default=None, description="Whether to enable expert parallelism for MoE models.")
    enable_ep_weight_filter: Optional[bool] = Field(default=None, description="Whether to skip loading expert weights that do not belong to this rank.")
    ...
    enable_eplb: Optional[bool] = Field(default=None, description="Whether to enable MoE expert load balancing.")
    ...
    enable_dbo: Optional[bool] = Field(default=None, description="Whether to enable dual batch overlap.")
    ...
    enable_chunked_prefill: Optional[bool] = Field(default=None, description="Whether to enable chunked prefill scheduling.")
    disable_chunked_mm_input: Optional[bool] = Field(default=None, description="Whether to disable chunked multimodal input scheduling.")
    ...
    scheduler_reserve_full_isl: Optional[bool] = Field(default=None, description="Whether to reserve memory for the full input sequence length when scheduling.")
    ...
    disable_hybrid_kv_cache_manager: Optional[bool] = Field(default=None, description="Whether to disable the hybrid KV cache manager and use uniform allocation instead.")
    async_scheduling: Optional[bool] = Field(default=None, description="Whether to enable background scheduling.")
    stream_interval: Optional[int] = Field(default=None, description="Token buffering interval for streaming.")

    # Multimodal
    language_model_only: Optional[bool] = Field(default=None, description="Whether to disable all multimodal inputs and run as a text-only model.")
    limit_mm_per_prompt: Optional[Dict[str, int]] = Field(default=None, description="Per-modality input limits.")
    enable_mm_embeds: Optional[bool] = Field(default=None, description="Whether to accept multimodal embedding inputs.")
    ...
    mm_encoder_only: Optional[bool] = Field(default=None, description="Whether to skip the language model component and run only the multimodal encoder.")
    ...
    interleave_mm_strings: Optional[bool] = Field(default=None, description="Whether to support interleaved text and media prompts.")
    skip_mm_profiling: Optional[bool] = Field(default=None, description="Whether to skip multimodal encoder memory profiling at startup.")
    video_pruning_rate: Optional[float] = Field(default=None, description="Video frame reduction rate.")

    # LoRA
    enable_lora: Optional[bool] = Field(default=None, description="Whether to enable LoRA adapter support.")
    ...
    fully_sharded_loras: Optional[bool] = Field(default=None, description="Whether to use fully sharded LoRA layers.")
    ...
    # Runtime modes
    enable_sleep_mode: Optional[bool] = Field(default=None, description="Whether to enable engine sleep mode when idle.")
    enable_cumem_allocator: Optional[bool] = Field(default=None, description="Whether to enable the advanced GPU memory allocator.")
    enable_log_requests: Optional[bool] = Field(default=None, description="Whether to log request information and parameters in AsyncEngine.")

    # Observability
    disable_log_stats: Optional[bool] = Field(default=None, description="Whether to disable engine statistics logging.")
    ...
    enable_layerwise_nvtx_tracing: Optional[bool] = Field(default=None, description="Whether to enable per-layer NVTX tracing.")

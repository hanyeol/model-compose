...
class BsRoFormerMusicSourceSeparationParamsConfig(CommonMusicSourceSeparationParamsConfig):
...
class BsRoFormerMusicSourceSeparationModelActionConfig(CommonMusicSourceSeparationModelActionConfig):

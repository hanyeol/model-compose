...
from mindor.dsl.schema.component import ChromeWebBrowserComponentConfig, WebBrowserDriverType
...
@register_web_browser_driver(WebBrowserDriverType.CHROME)
class ChromeWebBrowserService(WebBrowserDriver):

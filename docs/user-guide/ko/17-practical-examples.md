...
## 16.2 RAG 시스템 (벡터 DB 활용)

### 16.2.1 ChromaDB를 사용한 텍스트 임베딩 검색
...
## 16.3 그래프 스토어 (지식 그래프 & 소셜 네트워크)

### 16.3.1 Neo4j를 사용한 지식 그래프
...
### 16.6.1 텍스트를 음성으로 변환 (OpenAI TTS)

...
class SpeakerDiarizationModelActionConfig(CommonModelActionConfig):
    ...
    speaker_count: Optional[Union[int, str]] = Field(default=None, description="Exact number of speakers when known; otherwise leave unset and use the min/max hints.")
    min_speaker_count: Optional[Union[int, str]] = Field(default=None, description="Minimum number of speakers considered.")
    max_speaker_count: Optional[Union[int, str]] = Field(default=None, description="Maximum number of speakers considered.")

...
class BlackVideoAnalyzerActionConfig(CommonVideoAnalyzerActionConfig):
...
class FreezeVideoAnalyzerActionConfig(CommonVideoAnalyzerActionConfig):
...
class BrightnessVideoAnalyzerActionConfig(CommonVideoAnalyzerActionConfig):
...
class MotionVideoAnalyzerActionConfig(CommonVideoAnalyzerActionConfig):

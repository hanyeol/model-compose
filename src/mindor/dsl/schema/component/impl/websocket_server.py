...
class WebSocketServerComponentConfig(CommonComponentConfig):
    ...
    ping_interval: Optional[float] = Field(default=None, description="WebSocket ping interval in seconds.")
    ping_timeout: Optional[float] = Field(default=None, description="WebSocket ping timeout in seconds.")

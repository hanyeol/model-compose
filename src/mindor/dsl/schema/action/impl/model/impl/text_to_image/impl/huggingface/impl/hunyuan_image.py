...
class HunyuanImageHuggingfaceTextToImageParamsConfig(CommonHuggingfaceTextToImageParamsConfig):
...
class HunyuanImageHuggingfaceTextToImageModelActionConfig(CommonHuggingfaceTextToImageModelActionConfig):
    params: HunyuanImageHuggingfaceTextToImageParamsConfig = Field(default_factory=HunyuanImageHuggingfaceTextToImageParamsConfig, description="Image generation configuration parameters.")

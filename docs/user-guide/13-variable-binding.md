...
### 13.2.2 Component Response Variable Sources
...
### 13.2.3 Streaming Reference (Per-Chunk)
...
### 13.3.2 Object Array Conversion
...
### 13.4.1 SSE (Server-Sent Events) Streaming
...
### 13.5.2 Environment Variable Default Values
...
### 13.5.3 Nested Default Values (Environment Variable + Literal)

...
class InsightfaceFaceTrackingModelActionConfig(CommonFaceTrackingModelActionConfig):
    return_gender_age: Union[bool, str] = Field(default=False, description="Whether gender and age are included on each face; also emitted per-frame when 'return_frames' is enabled.")

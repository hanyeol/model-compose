...
class AzureBlobFileStoreComponentConfig(CommonFileStoreComponentConfig):
    ...
    connection_string: Optional[str] = Field(default=None, description="Azure Storage connection string (simplest authentication option).")
    account_name: Optional[str] = Field(default=None, description="Storage account name (used when connection_string is not provided).")
    account_key: Optional[str] = Field(default=None, description="Account key (used when connection_string is not provided).")
